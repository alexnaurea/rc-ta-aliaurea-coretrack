...
export class ValidationsHelper {
    ...
    static getStringEqualValidationWithElementName(actualValue: string,
                                                   expectedValue: string,
                                                   elementName: string) {
        return `'${actualValue}' should be equal to '${expectedValue}' for element: '${elementName}'`;
    }
    ...
    static getDropdwonValueShouldBe(selectElement: DfElement, actualValue: string) {
    ...
    static getElementsCountToBeEqualOrGreaterThan(expectedCount: number) {
        return `Elements count should be equal or greater than: ${expectedCount}`;
    }

    static getAlertMessageValidation(actualValue: string, expectedValue: string) {
        return `Alert text: '${actualValue}' should be equal to '${expectedValue}'`;
    }

    static getTrueValidation(value: boolean) {
